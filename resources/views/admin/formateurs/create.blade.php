...
<body>
    ...
    <div class="container">
        <h2 class="form-title">ADD AN PROFESSEUR :</h2>
                ...
                <div class="form-right">
                    <div class="matiers-section">
                        ...
                        <div class="matiers-grid">
                            ...
                            <button type="button" class="matier-btn" data-matier="developpment">DEVELOPMENT</button>
                            <button type="button" class="matier-btn" data-matier="reseau">Reseau</button>
                            <button type="button" class="matier-btn" data-matier="design">Design</button>
                        </div>
