...
<head>
    ...
    <title>Gestion Emploi Classes</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        ...
        <div class="search-bar">
            <input type="text" placeholder="SEARCH CLASSE">
        </div>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $classe->name }}</td>
                    <td>
                        <a href="{{ route('classe.update', $classe->id) }}" class="action-btn">UPDATE</a>
                        <a href="{{ route('classe.delete', $classe->id) }}" class="action-btn">DELETE</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
